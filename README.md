...
Enterprise-style Knowledge Base Agent using FastAPI, Neo4j GraphRAG, live FlytBase documentation retrieval, Groq for grounded answer synthesis, Cohere embeddings, and Postgres chat history.
...
- GraphRAG retrieval that combines graph expansion, Neo4j full-text, vector retrieval, structured analytics, reranking, and evidence selection.
...
If you want local Postgres and Neo4j instead of your cloud Neo4j:
...
5. Replaces chunks and embeddings only for changed records.
6. Soft-deletes records missing from the latest source scan.
